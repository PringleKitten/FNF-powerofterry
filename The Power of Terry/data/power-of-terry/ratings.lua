...
function onCountdownTick(counter)
	if counter == 1 then
        for _, valuea in pairs({'xS','xG','xB','xVB','xMss','xhp'}) do for _, valueb in pairs({'S','G','B','VB','Mss','hp'}) do
            doTweenX(valuea,valueb,325,0.4,'expoOut')
        end end
    elseif counter == 2 then
        for _, valuea in pairs({'xxS','xxG','xxB','xxVB','xxMss','xxhp'}) do for _, valueb in pairs({'S','G','B','VB','Mss','hp'}) do
            doTweenX(valuea,valueb,700,0.4,'expoOut')
        end end
...
function onTimerCompleted(tag, loops, loopsLeft)
    if tag == 'lol' then
        for _, valuea in pairs({'xS','xG','xB','xVB','xMss','xhp'}) do for _, valueb in pairs({'S','G','B','VB','Mss','hp'}) do
            doTweenX(valuea,valueb,0,0.5,'expoOut')
        end end
    end
    if tag == 'end4' then
        runTimer("lol", 0.2)
